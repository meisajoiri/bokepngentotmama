...
export default async function Video({ params }: PageProps) {
	...
	const jsonLd = {
        ...
        url: `https://bokepngentotmama.pages.dev/v/${file.filecode}`,
